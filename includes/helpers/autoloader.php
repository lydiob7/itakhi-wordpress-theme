...
namespace ITAKHI\Includes\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'includes' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/includes/%s/%s.php', untrailingslashit( ITAKHI_DIR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\ITAKHI\Includes\Helpers\autoloader' );
